  ...
  group(
    ...
    () {
      ...
      test('should clip rect', () async {
        ...
        await page.goto(server.prefix + '/grid.html');
        var screenshot = await page.screenshot(
          clip: Rectangle(50, 100, 150, 100),
        );
        expect(
          screenshot,
          equalsGolden('test/golden/screenshot-clip-rect.png'),
        );
      });
      ...
      test('should take fullPage screenshots', () async {
        ...
        expect(
          screenshot,
          equalsGolden('test/golden/screenshot-grid-fullpage.png'),
        );
      });
      test('should run in parallel in multiple pages', () async {
        var N = 2;
        var pages = await Future.wait(
          List.filled(N, 0).map((_) async {
      ...
      test('should work with odd clip size on Retina displays', () async {
        ...
        expect(
          screenshot,
          equalsGolden('test/golden/screenshot-clip-odd-size.png'),
        );
      });
  ...
  group(
    ...
    () {
      ...
      ''');
        ...
        expect(
          screenshot,
          equalsGolden('test/golden/screenshot-element-scrolled-into-view.png'),
        );
      });
