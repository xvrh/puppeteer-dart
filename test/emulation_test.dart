...
void main() {
  ...
  group('Page.viewport', () {
    ...
    test('should detect touch when applying viewport with touches', () async {
      await page.setViewport(
        DeviceViewport(width: 800, height: 600, hasTouch: true),
      );
    ...
    test('should support landscape emulation', () async {
      ...
      expect(
        await page.evaluate('() => screen.orientation.type'),
  ...
  group('Page.emulateTimezone', () {
    test('should work', () async {
      ...
      expect(
        await page.evaluate('() => date.toString()'),
        equals('Sat Nov 19 2016 15:12:34 GMT-0300 (Argentina Standard Time)'),
      );
