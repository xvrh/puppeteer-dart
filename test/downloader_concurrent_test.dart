  ...
  group('ensureBrowserDownloaded', () {
    ...
    test('concurrent calls in same isolate share a single download', () async {
      ...
      expect(
        downloadCount,
        1,
        reason: 'Future cache should dedupe concurrent calls',
      );
    ...
    test(
      ...
      () async {
        ...
        expect(
          Directory(versionPath).existsSync(),
          isFalse,
    ...
    test(
      'owner failure: waiter retries when .downloading disappears without exe',
      () async {
