...
class Key {
  ...
  static const Key backspace = Key._(
    keyCode: 8,
    code: 'Backspace',
    key: 'Backspace',
  );
  ...
  static const Key capsLock = Key._(
    keyCode: 20,
    code: 'CapsLock',
    key: 'CapsLock',
  );
  static const Key escape = Key._(keyCode: 27, code: 'Escape', key: 'Escape');
  static const Key convert = Key._(
    keyCode: 28,
    code: 'Convert',
    key: 'Convert',
  );
  static const Key nonConvert = Key._(
    keyCode: 29,
    code: 'NonConvert',
    key: 'NonConvert',
  );
  ...
  static const Key pageDown = Key._(
    keyCode: 34,
    code: 'PageDown',
    key: 'PageDown',
  );
  ...
  static const Key arrowUp = Key._(
    keyCode: 38,
    code: 'ArrowUp',
    key: 'ArrowUp',
  );
  static const Key arrowRight = Key._(
    keyCode: 39,
    code: 'ArrowRight',
    key: 'ArrowRight',
  );
  static const Key arrowDown = Key._(
    keyCode: 40,
    code: 'ArrowDown',
    key: 'ArrowDown',
  );
  ...
  static const Key printScreen = Key._(
    keyCode: 44,
    code: 'PrintScreen',
    key: 'PrintScreen',
  );
  ...
  static const Key contextMenu = Key._(
    keyCode: 93,
    code: 'ContextMenu',
    key: 'ContextMenu',
  );
  ...
  static const Key numLock = Key._(
    keyCode: 144,
    code: 'NumLock',
    key: 'NumLock',
  );
  ...
  static const Key audioVolumeMute = Key._(
    keyCode: 173,
    code: 'AudioVolumeMute',
    key: 'AudioVolumeMute',
  );
  static const Key audioVolumeDown = Key._(
    keyCode: 174,
    code: 'AudioVolumeDown',
    key: 'AudioVolumeDown',
  );
  static const Key audioVolumeUp = Key._(
    keyCode: 175,
    code: 'AudioVolumeUp',
    key: 'AudioVolumeUp',
  );
  static const Key mediaTrackNext = Key._(
    keyCode: 176,
    code: 'MediaTrackNext',
    key: 'MediaTrackNext',
  );
  ...
  static const Key mediaStop = Key._(
    keyCode: 178,
    code: 'MediaStop',
    key: 'MediaStop',
  );
  static const Key mediaPlayPause = Key._(
    keyCode: 179,
    code: 'MediaPlayPause',
    key: 'MediaPlayPause',
  );
  ...
  static const Key comma = Key._(
    keyCode: 188,
    code: 'Comma',
    shiftKey: '<',
    key: ',',
  );
  static const Key minus = Key._(
    keyCode: 189,
    code: 'Minus',
    shiftKey: '_',
    key: '-',
  );
  static const Key period = Key._(
    keyCode: 190,
    code: 'Period',
    shiftKey: '>',
    key: '.',
  );
  static const Key slash = Key._(
    keyCode: 191,
    code: 'Slash',
    shiftKey: '?',
    key: '/',
  );
  static const Key backquote = Key._(
    keyCode: 192,
    code: 'Backquote',
    shiftKey: '~',
    key: '`',
  );
  static const Key bracketLeft = Key._(
    keyCode: 219,
    code: 'BracketLeft',
    shiftKey: '{',
    key: '[',
  );
  static const Key backslash = Key._(
    keyCode: 220,
    code: 'Backslash',
    shiftKey: '|',
    key: r'\',
  );
  static const Key bracketRight = Key._(
    keyCode: 221,
    code: 'BracketRight',
    shiftKey: '}',
    key: ']',
  ...
  static const Key altGraph = Key._(
    keyCode: 225,
    code: 'AltGraph',
    key: 'AltGraph',
  );
  ...
  static const Key digit0 = Key._(
    keyCode: 48,
    code: 'Digit0',
    shiftKey: ')',
    key: '0',
  );
  static const Key digit1 = Key._(
    keyCode: 49,
    code: 'Digit1',
    shiftKey: '!',
    key: '1',
  );
  static const Key digit2 = Key._(
    keyCode: 50,
    code: 'Digit2',
    shiftKey: '@',
    key: '2',
  );
  static const Key digit3 = Key._(
    keyCode: 51,
    code: 'Digit3',
    shiftKey: '#',
    key: '3',
  );
  static const Key digit4 = Key._(
    keyCode: 52,
    code: 'Digit4',
    shiftKey: r'$',
    key: '4',
  );
  static const Key digit5 = Key._(
    keyCode: 53,
    code: 'Digit5',
    shiftKey: '%',
    key: '5',
  );
  static const Key digit6 = Key._(
    keyCode: 54,
    code: 'Digit6',
    shiftKey: '^',
    key: '6',
  );
  static const Key digit7 = Key._(
    keyCode: 55,
    code: 'Digit7',
    shiftKey: '&',
    key: '7',
  );
  static const Key digit8 = Key._(
    keyCode: 56,
    code: 'Digit8',
    shiftKey: '*',
    key: '8',
  );
  static const Key digit9 = Key._(
    keyCode: 57,
    code: 'Digit9',
    shiftKey: '(',
    key: '9',
  );
  static const Key keyA = Key._(
    keyCode: 65,
    code: 'KeyA',
    shiftKey: 'A',
    key: 'a',
  );
  static const Key keyB = Key._(
    keyCode: 66,
    code: 'KeyB',
    shiftKey: 'B',
    key: 'b',
  );
  static const Key keyC = Key._(
    keyCode: 67,
    code: 'KeyC',
    shiftKey: 'C',
    key: 'c',
  );
  static const Key keyD = Key._(
    keyCode: 68,
    code: 'KeyD',
    shiftKey: 'D',
    key: 'd',
  );
  static const Key keyE = Key._(
    keyCode: 69,
    code: 'KeyE',
    shiftKey: 'E',
    key: 'e',
  );
  static const Key keyF = Key._(
    keyCode: 70,
    code: 'KeyF',
    shiftKey: 'F',
    key: 'f',
  );
  static const Key keyG = Key._(
    keyCode: 71,
    code: 'KeyG',
    shiftKey: 'G',
    key: 'g',
  );
  static const Key keyH = Key._(
    keyCode: 72,
    code: 'KeyH',
    shiftKey: 'H',
    key: 'h',
  );
  static const Key keyI = Key._(
    keyCode: 73,
    code: 'KeyI',
    shiftKey: 'I',
    key: 'i',
  );
  static const Key keyJ = Key._(
    keyCode: 74,
    code: 'KeyJ',
    shiftKey: 'J',
    key: 'j',
  );
  static const Key keyK = Key._(
    keyCode: 75,
    code: 'KeyK',
    shiftKey: 'K',
    key: 'k',
  );
  static const Key keyL = Key._(
    keyCode: 76,
    code: 'KeyL',
    shiftKey: 'L',
    key: 'l',
  );
  static const Key keyM = Key._(
    keyCode: 77,
    code: 'KeyM',
    shiftKey: 'M',
    key: 'm',
  );
  static const Key keyN = Key._(
    keyCode: 78,
    code: 'KeyN',
    shiftKey: 'N',
    key: 'n',
  );
  static const Key keyO = Key._(
    keyCode: 79,
    code: 'KeyO',
    shiftKey: 'O',
    key: 'o',
  );
  static const Key keyP = Key._(
    keyCode: 80,
    code: 'KeyP',
    shiftKey: 'P',
    key: 'p',
  );
  static const Key keyQ = Key._(
    keyCode: 81,
    code: 'KeyQ',
    shiftKey: 'Q',
    key: 'q',
  );
  static const Key keyR = Key._(
    keyCode: 82,
    code: 'KeyR',
    shiftKey: 'R',
    key: 'r',
  );
  static const Key keyS = Key._(
    keyCode: 83,
    code: 'KeyS',
    shiftKey: 'S',
    key: 's',
  );
  static const Key keyT = Key._(
    keyCode: 84,
    code: 'KeyT',
    shiftKey: 'T',
    key: 't',
  );
  static const Key keyU = Key._(
    keyCode: 85,
    code: 'KeyU',
    shiftKey: 'U',
    key: 'u',
  );
  static const Key keyV = Key._(
    keyCode: 86,
    code: 'KeyV',
    shiftKey: 'V',
    key: 'v',
  );
  static const Key keyW = Key._(
    keyCode: 87,
    code: 'KeyW',
    shiftKey: 'W',
    key: 'w',
  );
  static const Key keyX = Key._(
    keyCode: 88,
    code: 'KeyX',
    shiftKey: 'X',
    key: 'x',
  );
  static const Key keyY = Key._(
    keyCode: 89,
    code: 'KeyY',
    shiftKey: 'Y',
    key: 'y',
  );
  static const Key keyZ = Key._(
    keyCode: 90,
    code: 'KeyZ',
    shiftKey: 'Z',
    key: 'z',
  ...
  @override
  String toString() =>
      'Key(keyCode: $keyCode, key: $key, shiftKey: $shiftKey, '
