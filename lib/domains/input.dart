...
class InputManager {
  ...
  /// [code] Unique DOM defined string value for each physical key (e.g.,
  /// 'KeyA') (default: "").
  ...
  /// any touch points, while TouchStart and TouchMove must contains at least
  /// one.
  /// [touchPoints] Active touch points on the touch device. One event per any
  /// changed point (compared to previous touch event in a sequence) is
  /// generated, emulating pressing/moving/releasing points one by one.
  /// [modifiers] Bit field representing pressed modifier keys. Alt=1, Ctrl=2,
  /// Meta/Command=4, Shift=8 (default: 0).
  /// [timestamp] Time at which the event occurred.
  ...
  /// [scaleFactor] Relative scale factor after zooming (>1.0 zooms in, <1.0
  /// zooms out).
  /// [relativeSpeed] Relative pointer speed in pixels per second (default:
  /// 800).
  ...
  /// left).
  /// [yDistance] The distance to scroll along the Y axis (positive to scroll
  /// up).
