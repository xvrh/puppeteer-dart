...
import '../domains/system_info.dart';
...
class Domains {
  ...
  BrowserApi get browser => _browser ??= BrowserApi(session);
  BrowserApi _browser;
  ...
  SystemInfoApi get systemInfo => _systemInfo ??= SystemInfoApi(session);
